...
- **Le cas bancal du deuxième magasin** : l'abonnement appartient au magasin
  qui l'a créé, mais `etat_abonnement_magasin` le rend pour **tout** magasin
  de l'entreprise. Changer l'offre d'un **autre** magasin modifierait donc les
  articles de celui-là. Non exercé, délibérément — c'est la limite « un
  abonnement par entreprise, un article par magasin » notée le 4 septembre, et
  elle mérite d'être regardée à froid.
