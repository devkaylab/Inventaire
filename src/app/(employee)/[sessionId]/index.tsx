...
function makeStyles(t: Theme) {
  return StyleSheet.create({
    ...
    countBtn: { backgroundColor: t.accent, borderRadius: Radius.bouton, paddingVertical: Spacing.lg, alignItems: 'center', ...t.shadowElevated },
    countBtnText: { color: t.onAccent, fontSize: 16, fontFamily: Font.bold },
    auditBtn: { backgroundColor: AUDIT_COLOR, borderRadius: Radius.bouton, paddingVertical: Spacing.lg, alignItems: 'center', ...t.shadowElevated },
