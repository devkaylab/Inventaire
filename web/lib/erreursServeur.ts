 ...
 *
 * Copie exacte de `src/lib/erreursServeur.ts` — un test compare les deux.
 */
...
export const ERREURS_SERVEUR: Record<string, string> = {
  ...
  'Mission introuvable': 'Mission not found',
  ...
  'Une équipe se constitue entre la confirmation et le départ.': 'A team is put together between confirmation and the start of the mission.',
...
export const PREFIXES: Array<[string, string]> = [
  ...
  ["Toutes les places d'inventoriste sont pourvues : ", 'Every inventory clerk slot is taken: '],
  ['Cette mission ne peut pas passer de « ', 'This mission cannot move from '],
]
