// Règles de mot de passe, alignées sur la politique du serveur.
//
// Supabase applique la sienne (longueur 12, minuscule + majuscule + chiffre +
// symbole, et refus des mots de passe compromis via HaveIBeenPwned) et répond
// en anglais, par un message technique, une fois le formulaire envoyé. Vérifier
// les mêmes règles ici sert à le dire **en français et avant l'envoi** — pas à
// remplacer le contrôle serveur, qui reste seul à faire foi.
//
// À maintenir avec la console : Authentication → Providers → Email. Un
// assouplissement là-bas sans mise à jour ici afficherait une exigence que le
// serveur n'a plus ; un durcissement laisserait passer une saisie que le
// serveur refusera.
