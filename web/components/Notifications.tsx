  ...
  return (
    <div className="rail-notif" ref={boiteRef}>
      ...
      <button
        ...
        onClick={basculer}
      >
        {/* ⚠️ LA PASTILLE S'ACCROCHE À L'ICÔNE, pas au bouton : depuis que le
            rail se déplie au survol (19 septembre 2026), le bouton prend toute
            la largeur de la rangée, et la pastille partait au bout. */}
        <span className="rail-icone">
        ...
        <span className="rail-nom">{t('Notifications')}</span>
      </button>
