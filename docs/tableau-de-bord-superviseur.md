...
de la base** le 19 août 2026 (migration `20260819174148`).
...
| `20260812000002_session_activity` | RPC `get_session_activity` + deux index sur `counts` (aucun ne couvrait `created_at`). **La RPC a été supprimée** par `20260819174148` ; les index restent utiles au fil des scans |
