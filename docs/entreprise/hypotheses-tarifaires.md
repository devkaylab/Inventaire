...
**Objet** : garder côte à côte les deux façons de facturer Quantinvo, avec ce
...
Ce qu'il ne faut pas faire, c'est panacher les deux sans le dire : afficher un
prix fixe et négocier au cas par cas revient à n'avoir aucun tarif, et le
premier prix consenti devient la référence pour tous les suivants.
